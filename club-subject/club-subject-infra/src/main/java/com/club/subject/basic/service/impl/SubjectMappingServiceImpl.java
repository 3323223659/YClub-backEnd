...
import com.club.subject.basic.mapper.SubjectMappingDao;
...
public class SubjectMappingServiceImpl implements SubjectMappingService {
     ...
     */
    @Override
    public List<String> queryLabelName(Long subjectId) {
        return this.subjectMappingDao.queryLabelName(subjectId);
    }
}
